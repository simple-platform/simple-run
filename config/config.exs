...
# config :client_data, ClientData.Mailer, adapter: Swoosh.Adapters.Local

config :client,
  generators: [context_app: :client_data]
...
config :client, Client.Endpoint,
  ...
  pubsub_server: ClientData.PubSub,
